<!-- Copia local de la ficha técnica oficial de Arduino. Modelo: Arduino® Nano. Fuente: https://github.com/arduino/docs-content/tree/2d8e26a9c986f1cdb5d1658031572ed6e9a9ba99/content/hardware/. Revisión congelada: 2d8e26a9c986f1cdb5d1658031572ed6e9a9ba99. Licencia: CC BY-SA 4.0. Modificación: se ha conservado solo la versión inglesa cuando el archivo repetía el contenido en chino; se han descargado los assets locales referenciados. -->
...
> **Nota editorial de preparación:** esta ficha contiene datos que no coinciden entre sus propios apartados y con `especificaciones.md`, entre ellos el tipo de conector USB, el número de pines digitales y los márgenes de alimentación. Se conserva la fuente sin corregirla; señala la discrepancia si afecta a una respuesta.
